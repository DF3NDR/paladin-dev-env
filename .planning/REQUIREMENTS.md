...
- [x] **PRICE-02**: A pure function maps a `TokenUsage` and the price table to an exact cost in
...
- [x] **PRICE-03**: A completed run reports its currency cost in `ExecutionMetadata.cost_estimate`
