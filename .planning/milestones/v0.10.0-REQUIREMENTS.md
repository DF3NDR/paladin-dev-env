# Requirements Archive: v0.10.0 Durable Agent Execution Runtime
...
**Archive outcome (v0.10.0 close, 2026-09-23):** 88 of 89 v1 requirements complete and
verified (checkboxes and the traceability table below are the as-closed state, untouched).
Outcomes: **validated** — ENG-01…08, CF-01…05, HITL-01…05, FT-01…06, RT-01…07, PLAT-01…06,
OBS-01…04, SHIP-01…04, SHIP-06, VOCAB-01…07, ACCT-01…05, PRIM-01…05, COMM-01…04, CURR-01…21;
**superseded** — SHIP-05 ("v0.10.0 is released"), deliberately left `[ ]` because the `v0.10.0`
tag's pipeline published 3 of 12 crates and cannot complete forward; SHIP-06 (`v0.10.1`) delivers
the outcome it secured (amend-at-source note dated 2026-09-22 under SHIP-05 below; row 707 of the
traceability table reads `Superseded`). **Adjusted at scope time, recorded in the header:** RT-06
scoped as conformance close-out rather than greenfield (PRD 05 stale on provider coverage); X-03
superseded for Phases 31-33 only by ADR-0051 (clean breaks with `MIGRATION.md` §9.2 rows, no
shims); Epic 2's deprecation-shim bullet overridden by its own R3 (ACCT-02). **Dropped:** none.
The v2 list (FUT-01…10) and the Out of Scope table are carried forward for the next milestone's
requirements definition, not restated here.
