...
All notable changes to `paladin-notifications` will be documented in this file.
...
### Changed
- Notification API stability documentation aligned with crate-tier stability expectations.
