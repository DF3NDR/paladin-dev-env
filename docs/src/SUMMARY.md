...
- [Output Formatting](user-guides/output-formatting.md)
...
- [Grove](appendix/grove.md)
- [Council](appendix/council.md)
- [Sentinel](appendix/sentinel.md)
- [Conclave Pattern](appendix/conclave-pattern.md)
- [Battalion Patterns Guide](appendix/battalion-patterns-guide.md)
- [Flow DSL Guide](appendix/flow-dsl-guide.md)
- [CLI Usage](appendix/cli-usage.md)
- [User System](appendix/user-system.md)
- [User REST API](appendix/user-rest-api.md)
- [Provider Expansion](appendix/provider-expansion.md)
- [Battalion Vision Support](appendix/battalion-vision-support.md)
- [Integration Tests](appendix/integration-tests.md)
- [Security Scanning](appendix/security-scanning.md)
- [Branch Protection](appendix/branch-protection.md)
- [Build Baselines](appendix/build-baselines.md)
- [Performance Baseline](appendix/performance-baseline.md)
- [Battalion Benchmarks](appendix/battalion-benchmarks.md)
- [Sanctum Benchmarks](appendix/sanctum-benchmarks.md)
- [Sanctum Deployment](appendix/sanctum-deployment.md)
...
- [CLI Muster](appendix/cli-muster.md)
- [CLI Onboarding](appendix/cli-onboarding.md)
- [CLI Setup Check](appendix/cli-setup-check.md)
- [CLI Testing](appendix/cli-testing.md)
- [Contributing (Legacy)](appendix/contributing-legacy.md)
