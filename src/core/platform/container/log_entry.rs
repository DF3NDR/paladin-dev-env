...
// */
// TODO fix the logging container
...
//             LogDestination::ErrorLog => todo!("Implement ErrorLog location"),
//             LogDestination::AccessLog => todo!("Implement AccessLog location"),
//             LogDestination::SystemLog => todo!("Implement SystemLog location"),
//         };
